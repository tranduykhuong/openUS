    ...
    return (
        <div className="my-5">
            <div className={classes.Register}>
                {step === 1 && (
                    <form onSubmit={handleRegister} className={classes.step1}>
                        <div className={classes.logo}>
                            {<h2 className={'text-uppercase font-weight-bold text-primary text-center'}>OpenUs</h2>}
                        </div>
                        <div className={`${classes.input}`}>
                            <input placeholder="Nhập tên của bạn" spellCheck="false" onChange={nameChangeHandler} />
                        </div>
                        <div className={`${classes.input}`}>
                            <input
                        ...
                        <div className={`${classes.input} ${passwordWrong && 'inputWrongRegister'}`}>
                            <input
                        ...
                        <div className={`${classes.input} ${confirmPasswordWrong && 'inputWrongRegister'}`}>
                            <input
                        ...
                        <div className={classes.iconBack} onClick={() => navigate(-1)}>
                            <svg
                                width="20"
                                height="20"
                                viewBox="0 0 20 20"
                        ...
                        {accountWrong && <div className={classes.wrongGmailRegister}>Gmail của bạn không hợp lệ.</div>}
                        {accountExist && <div className={classes.existGmailRegister}>Gmail đã tồn tại.</div>}
                        {passwordWrong && (
                            <div className={classes.wrongPasswordRegister}>Mật khẩu của bạn không hợp lệ</div>
                        )}
                        {confirmPasswordWrong && (
                            <div className={classes.wrongConfirmRegister}>Mật khẩu của bạn không trùng khớp</div>
                        )}
                    </form>
                )}
